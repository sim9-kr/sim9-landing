    ...
    try {
        ...
        if (json.success) {
            ...
            displayData.forEach(function(product) {
                var testPrice = product.Price_KRW;
                ...
                card += '<div style="display: flex; align-items: baseline; gap: 5px; margin-bottom: 20px;">';
                card += '<span style="font-size: 1.5rem; font-weight: 800; color: #222;">\u20A9' + testPrice.toLocaleString() + '</span>';
                card += '</div>';
